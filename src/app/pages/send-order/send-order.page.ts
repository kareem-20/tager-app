...
export class SendOrderPage implements OnInit {
  ...
  async createBody() {
    const body = {
      ...
      info: JSON.stringify({
        ...
        SERVICE: 0,
        TOTAL_CASH: 0,
        DELIVERYCOST: this.selectedZone?.REGION_SELL,
        USER_CREATE: 'online',
        CASH_PAID: 0,
        CASH_AMO: 0,
        REMAIN_AMO: 0,
  ...
  get cartDetail() {
    ...
    details.push({
      ...
      PRICE: this.deliveryCost + this.paidCash,
      PRICE_SALE_1: this.deliveryCost,
      PRICE_SALE_2: 0,
      totalPriceMandob: this.deliveryCost,
      totalNetProfitMandob:
        this.deliveryCost - (this.deliveryCost + this.paidCash),
      PRICE_SALE_3: 0,
      ITEM_NOTE: '',
      NOTE: '',
      IMG_URL: '',
